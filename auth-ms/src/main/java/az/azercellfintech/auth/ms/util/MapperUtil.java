package az.azercellfintech.auth.ms.util;

import az.azercellfintech.auth.ms.exception.JsonParserException;
...
import static az.azercellfintech.auth.ms.factory.ObjectMapperFactory.MAPPER_FACTORY;
