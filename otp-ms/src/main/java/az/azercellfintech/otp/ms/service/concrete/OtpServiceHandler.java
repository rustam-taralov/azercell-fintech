package az.azercellfintech.otp.ms.service.concrete;
...
import az.azercellfintech.otp.ms.service.abstraction.OtpService;
...
public class OtpServiceHandler implements OtpService {
    RedisUtil redisUtil;
